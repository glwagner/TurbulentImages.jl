...
function image_to_initial_condition(img_filename; topology = (Periodic, Flat, Bounded))
                                    
    color_img = load(img_filename)
    ...
    native_grid = RectilinearGrid(size=(Ix, Iz); x, z, topology)
